...
function AboutSection({ profile, scheme, T }) {
  ...
  return (
    <section style={{
      ...
      display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: T.gap3,
    }}>
      <div>
        <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: T.gap1 }}>
          <div style={{
            ...
            <img src={window.__resources.miyamakirishima}
                 alt="ミヤマキリシマ咲く山"
          ...
          <div style={{
            ...
            <img src={window.__resources.snowMountain}
                 alt="雪山と氷の池"
                 style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
          </div>
        </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <div style={{
          ...
          <p style={{ margin: 0 }}>
            <span style={{ whiteSpace: "nowrap" }}>50代、162.5cmのアクティブミニマリスト。</span>2023年6月に登山を始め、3年で60座の山を越えてきました。乳がんの手術を経験し、一度立ち止まったからこそ見えた景色があります。
          </p>
          <p style={{ margin: `${T.gap1}px 0 0`, color: T.readable ? scheme.fg : scheme.muted }}>
            信頼できるギアと共に歩む登山と旅の記録を綴ります。「自分にとっての心地よさ」を追求する日々の記録です。
          </p>
        </div>
      </div>
    </section>
